...
- Possible other predictors: age, Glasgow Coma Scale (GCS) at baseline, NIH stroke scale (NIHSS) at baseline, stable Intracerebral and Intraventricular volumes, and end of surgical evacuation ICH volume <15 mL (i.e., whether patients who had surgery had successful removal of blood clot). We will adjust these variables in our model.
...
**??use dataset after removing NAs?**
...
Now look at the clinical characteristics of patients within traning data and testing data.
